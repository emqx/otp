...
ocsp_stapling_helper(Config, Opts) ->
    ...
    Data = "ping",  %% 4 bytes
    GroupName = undefined,
    ServerOpts0 = proplists:get_value(custom_server_opts, Config, []),
    ServerOpts = [{group, GroupName} | ServerOpts0],
    ServerType = proplists:get_value(server_type, Config, openssl_ocsp),
